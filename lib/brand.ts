 ...
 * «забирают». С 21.09.2026 оплата идёт сразу при оформлении — но пока
 * касса не подключена, на кнопке остаётся бронь: см. lib/pay.ts.
 */
export const CTA = "Забрать эксклюзив";
export const CTA_HOLD = "Забронировать эксклюзив";
...
export const nav = [
  ...
  // Пока касса не подключена, раздел называется «Визит и бронь»
  { href: "/visit", label: payEnabled ? "Визит и покупка" : "Визит и бронь" },
