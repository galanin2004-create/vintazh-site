...
const segments = [
  {
    ...
    hook: "Происхождение вещи, эпоха, фактура",
  },
  {
            ...
            <Reveal>
              <div style={{ display: "flex", flexDirection: "column", gap: "22px" }}>
                <p className="text">
                  ...
                  эпоху и свою историю. Мы говорим о них так, как галерея говорит
          ...
          <div className="twoCol">
            ...
            <Reveal delay={90}>
              <ul className="list">
                ...
                <li>Понятная эпоха: год или десятилетие определяются по крою и фурнитуре.</li>
