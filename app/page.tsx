        ...
        <div className="shell">
          <Reveal>
            <div className="head" style={{ marginBottom: "clamp(28px, 4vw, 48px)" }}>
              ...
              <p className="text">
                Каждая вещь отобрана вручную, имеет происхождение и свою
        ...
        <div className="shell">
          <Reveal>
            <div className="head" style={{ marginBottom: "clamp(28px, 4vw, 44px)" }}>
              ...
              <h2>Два способа найти своё</h2>
              <p className="text">
                Каталог фильтруется по двум осям одновременно. Любая вещь описана
                обеими: страна изготовителя и тип вещи.
              </p>
            </div>
          </Reveal>
